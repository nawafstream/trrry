...
class GoogleDrive:
    def __init__(self):
        self.client_id = "245321815916-fn1o8khj4j0k99l8up5tg0dg1mdq3ltb.apps.googleusercontent.com"
        # ==================== السيكرت الجديد والصحيح هنا ====================
        self.client_secret = "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"
        # ===================================================================
